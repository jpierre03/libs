 ...
 * byte first) order.
 * <p/>
 * The client should not intermix calls to <tt>edu.princeton.cs.algs4.BinaryStdIn</tt> with calls
 * to <tt>edu.princeton.cs.algs4.StdIn</tt> or <tt>System.in</tt>;
...
public final class BinaryStdIn {
    ...
    /**
     * edu.princeton.cs.algs4.Test client. Reads in a binary input file from standard input and writes

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.IndexMaxPQ.java
 *  Execution:    java edu.princeton.cs.algs4.IndexMaxPQ
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.IndexMaxPQ</tt> class represents an indexed priority queue of generic keys.
 * It supports the usual <em>insert</em> and <em>delete-the-maximum</em>
 * operations, along with <em>delete</em> and <em>change-the-key</em>
 * methods. edu.princeton.cs.algs4.In order to let the client refer to items on the priority queue,
...
public class IndexMaxPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
    ...
    /**
     * ***********************************************************
     * edu.princeton.cs.algs4.Heap helper functions
     * ************************************************************
     */
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.IndexMaxPQ</tt> data type.
     */

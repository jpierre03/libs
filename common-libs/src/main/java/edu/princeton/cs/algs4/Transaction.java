 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Transaction.java
 *  Execution:    java edu.princeton.cs.algs4.Transaction
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.Transaction</tt> class is an immutable data type to encapsulate a

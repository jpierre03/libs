 ...
 *  Compilation:  javac edu.princeton.cs.algs4.DepthFirstOrder.java
 *  Execution:    java edu.princeton.cs.algs4.DepthFirstOrder filename.txt
 *  Dependencies: edu.princeton.cs.algs4.Digraph.java edu.princeton.cs.algs4.Queue.java edu.princeton.cs.algs4.Stack.java edu.princeton.cs.algs4.StdOut.java
 *                edu.princeton.cs.algs4.EdgeWeightedDigraph.java edu.princeton.cs.algs4.DirectedEdge.java
 ...
 *  Runs in O(E + V) time.
 *
 *  % java edu.princeton.cs.algs4.DepthFirstOrder tinyDAG.txt
 *     v  pre post
 *  --------------
 *     0    0    8
 *     1    3    2
...
/**
 * The <tt>edu.princeton.cs.algs4.DepthFirstOrder</tt> class represents a data type for
...
public class DepthFirstOrder {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.DepthFirstOrder</tt> data type.
     */

 ...
 *  Compilation:  javac -cp .:jama.jar edu.princeton.cs.algs4.PolynomialRegression.java
 *  Execution:    java  -cp .:jama.jar edu.princeton.cs.algs4.PolynomialRegression
 *  Dependencies: jama.jar edu.princeton.cs.algs4.StdOut.java
 *
 *  % java -cp .:jama.jar edu.princeton.cs.algs4.PolynomialRegression
...
/**
 * The <tt>edu.princeton.cs.algs4.PolynomialRegression</tt> class performs a polynomial regression

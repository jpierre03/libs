 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Point2D.java
 *  Execution:    java edu.princeton.cs.algs4.Point2D x0 y0 N
 *  Dependencies: edu.princeton.cs.algs4.StdDraw.java edu.princeton.cs.algs4.StdRandom.java
 *
 ...
 * Double with respect to -0.0 and +0.0, the edu.princeton.cs.algs4.Point2D constructor converts

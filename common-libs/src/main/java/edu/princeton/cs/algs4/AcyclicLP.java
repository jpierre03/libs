 ...
 *  Compilation:  javac edu.princeton.cs.algs4.AcyclicLP.java
 ...
 *
 *  % java edu.princeton.cs.algs4.AcyclicLP tinyEWDAG.txt 5
...
/**
 * The <tt>edu.princeton.cs.algs4.AcyclicLP</tt> class represents a data type for solving the

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.DepthFirstDirectedPaths.java
 *  Execution:    java edu.princeton.cs.algs4.DepthFirstDirectedPaths G s
 *  Dependencies: edu.princeton.cs.algs4.Digraph.java edu.princeton.cs.algs4.Stack.java
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.DepthFirstDirectedPaths</tt> class represents a data type for finding
...
public class DepthFirstDirectedPaths {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.DepthFirstDirectedPaths</tt> data type.
     */

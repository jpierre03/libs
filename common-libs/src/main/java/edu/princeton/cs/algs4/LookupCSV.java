...
/**
 * **********************************************************************
 * Compilation:  javac edu.princeton.cs.algs4.LookupCSV.java
 * Execution:    java edu.princeton.cs.algs4.LookupCSV file.csv keyField valField
 * Dependencies: edu.princeton.cs.algs4.ST.java edu.princeton.cs.algs4.In.java edu.princeton.cs.algs4.StdIn.java edu.princeton.cs.algs4.StdOut.java
 ...
 * <p/>
 * % java edu.princeton.cs.algs4.LookupCSV amino.csv 0 3     % java edu.princeton.cs.algs4.LookupCSV ip.csv 0 1
 * TTA                                www.google.com
 * Leucine                            216.239.41.99
 * ABC
 * Not found                          % java edu.princeton.cs.algs4.LookupCSV ip.csv 1 0
 * TCT                                216.239.41.99
 * Serine                             www.google.com
 * <p/>
 * % java edu.princeton.cs.algs4.LookupCSV amino.csv 3 0     % java edu.princeton.cs.algs4.LookupCSV DJIA.csv 0 1
 * Glycine                            29-Oct-29
 * GGG                                252.38
 * 20-Oct-87
 * 1738.74

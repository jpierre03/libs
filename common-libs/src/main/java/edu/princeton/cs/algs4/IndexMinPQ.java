 ...
 *  Compilation:  javac edu.princeton.cs.algs4.IndexMinPQ.java
 *  Execution:    java edu.princeton.cs.algs4.IndexMinPQ
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.IndexMinPQ</tt> class represents an indexed priority queue of generic keys.
 * It supports the usual <em>insert</em> and <em>delete-the-minimum</em>
 * operations, along with <em>delete</em> and <em>change-the-key</em>
 * methods. edu.princeton.cs.algs4.In order to let the client refer to keys on the priority queue,
...
public class IndexMinPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.IndexMinPQ</tt> data type.
     */

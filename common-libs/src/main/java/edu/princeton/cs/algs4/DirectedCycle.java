 ...
 *  Compilation:  javac edu.princeton.cs.algs4.DirectedCycle.java
 *  Execution:    java edu.princeton.cs.algs4.DirectedCycle < input.txt
 *  Dependencies: edu.princeton.cs.algs4.Digraph.java edu.princeton.cs.algs4.Stack.java edu.princeton.cs.algs4.StdOut.java edu.princeton.cs.algs4.In.java
 ...
 *  edu.princeton.cs.algs4.Cycle: 3 5 4 3
 *
 *  %  java edu.princeton.cs.algs4.DirectedCycle tinyDAG.txt
 *  No cycle
 *
 *************************************************************************/

/**
 * The <tt>edu.princeton.cs.algs4.DirectedCycle</tt> class represents a data type for
...
public class DirectedCycle {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.DirectedCycle</tt> data type.
     */

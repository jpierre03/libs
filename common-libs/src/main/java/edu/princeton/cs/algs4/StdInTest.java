 ...
 * edu.princeton.cs.algs4.Test client for edu.princeton.cs.algs4.StdIn and edu.princeton.cs.algs4.In.
 **/
...
public class StdInTest {
    ...
    /**
     * edu.princeton.cs.algs4.In the two methods below, each Object[] of "steps" is a length-2
    ...
    public static void test(String input, Object[][] steps, boolean useStdIn) {
        ...
        if (useStdIn) {
            ...
            try { //call edu.princeton.cs.algs4.StdIn.resync();

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Cycle.java
 *  Dependencies: edu.princeton.cs.algs4.Graph.java edu.princeton.cs.algs4.Stack.java
 *
 *  Identifies a cycle.
 *  Runs in O(E + V) time.
 *
 *  % java edu.princeton.cs.algs4.Cycle tinyG.txt
 *  3 4 5 3
 *
 *  % java edu.princeton.cs.algs4.Cycle mediumG.txt
 *  15 0 225 15
 *
 *  % java edu.princeton.cs.algs4.Cycle largeG.txt
 *  996673 762 840164 4619 785187 194717 996673
 *
 *************************************************************************/

/**
 * The <tt>edu.princeton.cs.algs4.Cycle</tt> class represents a data type for
...
public class Cycle {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.Cycle</tt> data type.
     */

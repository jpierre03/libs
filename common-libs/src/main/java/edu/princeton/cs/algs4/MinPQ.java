 ...
 *  Compilation:  javac edu.princeton.cs.algs4.MinPQ.java
 *  Execution:    java edu.princeton.cs.algs4.MinPQ < input.txt
 *
 *  Generic min priority queue implementation with a binary heap.
 *  Can be used with a comparator instead of the natural order.
 *
 *  % java edu.princeton.cs.algs4.MinPQ < tinyPQ.txt
 *  E A E (6 left on pq)
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.MinPQ</tt> class represents a priority queue of generic keys.
...
public class MinPQ<Key> implements Iterable<Key> {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.MinPQ</tt> data type.
     */

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.SequentialSearchST.java
 *  Execution:    java edu.princeton.cs.algs4.SequentialSearchST
 ...
 *
 *  % java edu.princeton.cs.algs4.SequentialSearchST < tiny.txt
 *  L 11
 *  P 10
 *  M 9
 *  X 7
...
/**
 * The <tt>edu.princeton.cs.algs4.SequentialSearchST</tt> class represents an (unordered)
...
public class SequentialSearchST<Key, Value> {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.SequentialSearchST</tt> data type.
     */

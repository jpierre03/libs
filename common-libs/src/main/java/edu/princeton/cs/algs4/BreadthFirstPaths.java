 ...
 *  Compilation:  javac edu.princeton.cs.algs4.BreadthFirstPaths.java
 *  Execution:    java edu.princeton.cs.algs4.BreadthFirstPaths G s
 *  Dependencies: edu.princeton.cs.algs4.Graph.java edu.princeton.cs.algs4.Queue.java edu.princeton.cs.algs4.Stack.java edu.princeton.cs.algs4.StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/41undirected/tinyCG.txt
 *
 *  Run breadth first search on an undirected graph.
 *  Runs in O(E + V) time.
 *
 *  %  java edu.princeton.cs.algs4.Graph tinyCG.txt
 *  6 8
 *  0: 2 1 5
 *  1: 0 2
 *  2: 0 1 3 4
 ...
 *  5: 3 0
 *
 *  %  java edu.princeton.cs.algs4.BreadthFirstPaths tinyCG.txt 0
 *  0 to 0 (0):  0
 *  0 to 1 (1):  0-1
 *  0 to 2 (1):  0-2
 *  0 to 3 (2):  0-2-3
 ...
 *  0 to 5 (1):  0-5
 *
 *  %  java edu.princeton.cs.algs4.BreadthFirstPaths largeG.txt 0
 *  0 to 0 (0):  0
...
/**
 * The <tt>edu.princeton.cs.algs4.BreadthFirstPaths</tt> class represents a data type for finding
...
public class BreadthFirstPaths {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.BreadthFirstPaths</tt> data type.
     */

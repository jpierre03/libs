 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Shell.java
 *  Execution:    java edu.princeton.cs.algs4.Shell < input.txt
 ...
 *
 *  % java edu.princeton.cs.algs4.Shell < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *
 *  % java edu.princeton.cs.algs4.Shell < words3.txt
...
/**
 * The <tt>edu.princeton.cs.algs4.Shell</tt> class provides static methods for sorting an
 * array using Shellsort with edu.princeton.cs.algs4.Knuth's increment sequence (1, 4, 13, 40, ...).
 * <p/>

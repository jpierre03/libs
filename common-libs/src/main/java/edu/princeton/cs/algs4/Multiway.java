 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Multiway.java
 *  Execution:    java edu.princeton.cs.algs4.Multiway input1.txt input2.txt input3.txt ...
 *  Dependencies: edu.princeton.cs.algs4.IndexMinPQ.java edu.princeton.cs.algs4.In.java edu.princeton.cs.algs4.StdOut.java
 *
 ...
 *  A B E F J N
 *
 *  % java edu.princeton.cs.algs4.Multiway m1.txt m2.txt m3.txt
 *  A A B B B C D E F F G H I I J N P Q Q Z
 *
 *************************************************************************/

/**
 * The <tt>edu.princeton.cs.algs4.Multiway</tt> class provides a client for reading in several

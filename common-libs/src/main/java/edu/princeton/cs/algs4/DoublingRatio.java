 ...
 *  Compilation:  javac edu.princeton.cs.algs4.DoublingRatio.java
 *  Execution:    java edu.princeton.cs.algs4.DoublingRatio
...
/**
 * The <tt>edu.princeton.cs.algs4.DoublingRatio</tt> class provides a client for measuring
...
public class DoublingRatio {
    ...
    /**
     * Returns the amount of time to call <tt>edu.princeton.cs.algs4.ThreeSum.count()</tt> with <em>N</em>
     * random 6-digit integers.
     *
     * @param N the number of integers
     * @return amount of time (in seconds) to call <tt>edu.princeton.cs.algs4.ThreeSum.count()</tt>
    ...
    /**
     * Prints table of running times to call <tt>edu.princeton.cs.algs4.ThreeSum.count()</tt>

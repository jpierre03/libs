...
/*************************************************************************
 *  Compilation:  javac edu.princeton.cs.algs4.StdArrayIO.java
 *  Execution:    java edu.princeton.cs.algs4.StdArrayIO < input.txt
 *
 ...
 *    1 1 1
 *
 *  % cat tinyDouble1D.txt tinyDouble2D.txt tinyBoolean2D.txt | java edu.princeton.cs.algs4.StdArrayIO
 *  4

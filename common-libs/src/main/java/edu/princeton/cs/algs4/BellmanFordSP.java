 ...
 *  Compilation:  javac edu.princeton.cs.algs4.BellmanFordSP.java
 *  Execution:    java edu.princeton.cs.algs4.BellmanFordSP filename.txt s
 *  Dependencies: edu.princeton.cs.algs4.EdgeWeightedDigraph.java edu.princeton.cs.algs4.DirectedEdge.java edu.princeton.cs.algs4.Queue.java
 ...
 *  reachable from s.
 *
 *  % java edu.princeton.cs.algs4.BellmanFordSP tinyEWDn.txt 0
 *  0 to 0 ( 0.00)
 ...
 *
 *  % java edu.princeton.cs.algs4.BellmanFordSP tinyEWDnc.txt 0
 *  4->5  0.35
 *  5->4 -0.66
 *
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.BellmanFordSP</tt> class represents a data type for solving the
...
public class BellmanFordSP {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.BellmanFordSP</tt> data type.
     */

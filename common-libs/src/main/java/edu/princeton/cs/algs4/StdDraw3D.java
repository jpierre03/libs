 ...
 * edu.princeton.cs.algs4.StdDraw3D.java
 * Hayk Martirosyan
 ******************************************************************************
 * 3D Drawing Library
 *
 * Standard edu.princeton.cs.algs4.Draw 3D is a Java library with the express goal of making it
 ...
 * Standard edu.princeton.cs.algs4.Draw 3D is a Java library with the express goal of making it
 * simple to create three-dimensional models, simulations, and games.
 * Here is a <a href = "http://introcs.cs.princeton.edu/java/stddraw3d">edu.princeton.cs.algs4.StdDraw3D tutorial</a>
 * and the
 * <a href = "http://introcs.cs.princeton.edu/java/stddraw3d/stddraw3d-manual.html">edu.princeton.cs.algs4.StdDraw3D reference manual</a>.
 *
...
/*                 while (!showedOnce) {
            ...
            //    catch (InterruptedException e) { System.out.println("Error sleeping"); }
            //}
            //edu.princeton.cs.algs4.StdOut.println("showed once is false, rendered once");
            showedOnce = false;
            //renderedOnce = true;
     ...
     * -------------------------------------- <br>
     * edu.princeton.cs.algs4.StdDraw3D.ORBIT_MODE: <br>
     ...
     * -------------------------------------- <br>
     * edu.princeton.cs.algs4.StdDraw3D.FPS_MODE: <br>
     ...
     * Mouse       - Look <br>
     * -------------------------------------- <br>
     * edu.princeton.cs.algs4.StdDraw3D.AIRPLANE_MODE: <br>
     ...
     * Mouse       - Look <br>
     * -------------------------------------- <br>
     * edu.princeton.cs.algs4.StdDraw3D.LOOK_MODE: <br>
     * No movement, but uses mouse to look around. <br>
     * <br>
     * Mouse - Look <br>
     * -------------------------------------- <br>
     * edu.princeton.cs.algs4.StdDraw3D.FIXED_MODE: <br>
     ...
     * default field of view. edu.princeton.cs.algs4.In this mode, closer objects appear
     ...
     * given field of view. edu.princeton.cs.algs4.In this mode, closer objects appear
     ...
     * edu.princeton.cs.algs4.In this mode, parallel lines remain parallel after
    ...
    private static void render3D() {
        ...
        //edu.princeton.cs.algs4.StdOut.println("showed once = true");
    }
    /* ***************************************************************
    ...
    /**
     * edu.princeton.cs.algs4.Draw picture (gif, jpg, or png) centered on (x, y), rescaled to w-by-h.
     */
    ...
    /**
     * edu.princeton.cs.algs4.Draw picture (gif, jpg, or png) centered on (x, y), rotated
    ...
    /**
     * When you create a light in edu.princeton.cs.algs4.StdDraw3D, it returns a Light object. Light
    ...
    public static class Vector3D {
        ...
        */
         ...
         *
         * @param that edu.princeton.cs.algs4.Vector to dot with
         ...
         *
         * @param that edu.princeton.cs.algs4.Vector to compute distance between
         ...
         *
         * @param that edu.princeton.cs.algs4.Vector to compute sum with
         ...
         *
         * @param that edu.princeton.cs.algs4.Vector to compute difference with
        ...
        /**
         * Draws this vector as a point from the origin to edu.princeton.cs.algs4.StdDraw3D.
         */
        public void draw() {
        ...
        public void drawLine (Vector3D origin) {
            ...
            edu.princeton.cs.algs4.StdDraw3D.line(origin.x, origin.y, origin.z, end.x, end.y, end.z);
        }
        */
    }

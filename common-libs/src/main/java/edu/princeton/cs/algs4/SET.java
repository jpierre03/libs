 ...
 *  Compilation:  javac edu.princeton.cs.algs4.SET.java
 *  Execution:    java edu.princeton.cs.algs4.SET
 *
 *  Set implementation using Java's TreeSet library.
 *  Does not allow duplicates.
 *
 *  % java edu.princeton.cs.algs4.SET
 *  128.112.136.11
 *  208.216.181.15
 *  null
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.SET</tt> class represents an ordered set of comparable keys.
...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.SET</tt> data type.
     */

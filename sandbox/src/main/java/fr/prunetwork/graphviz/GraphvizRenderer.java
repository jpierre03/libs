...
public enum GraphvizRenderer {
    DOT("/usr/bin/dot", "c:/Program Files/Graphviz2.30.1/bin/dot.exe", "/usr/local/Cellar/graphviz/2.36.0_1/bin/dot"),
    NEATO("/usr/bin/neato", "c:/Program Files/Graphviz2.30.1/bin/neato.exe", "/usr/local/Cellar/graphviz/2.36.0_1/bin/neato");

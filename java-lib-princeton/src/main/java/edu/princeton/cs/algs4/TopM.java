 ...
 *  Compilation:  javac edu.princeton.cs.algs4.TopM.java
 *  Execution:    java edu.princeton.cs.algs4.TopM M < input.txt
 *  Dependencies: edu.princeton.cs.algs4.MinPQ.java edu.princeton.cs.algs4.Transaction.java edu.princeton.cs.algs4.StdIn.java edu.princeton.cs.algs4.StdOut.java
 ...
 *  each line contains a String and a long value, this edu.princeton.cs.algs4.MinPQ client
 *  prints the M lines whose numbers are the highest.
 *
 *  % java edu.princeton.cs.algs4.TopM 5 < tinyBatch.txt
...
/**
 * The <tt>edu.princeton.cs.algs4.TopM</tt> class provides a client that reads a sequence of

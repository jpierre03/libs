 ...
 * Compilation:  javac edu.princeton.cs.algs4.FloydWarshall.java
 * Execution:  java edu.princeton.cs.algs4.FloydWarshall V E
 * Dependencies: edu.princeton.cs.algs4.AdjMatrixEdgeWeightedDigraph.java
 *
 * Floyd-Warshall all-pairs shortest path algorithm.
 *
 * % java edu.princeton.cs.algs4.FloydWarshall 100 500
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.FloydWarshall</tt> class represents a data type for solving the
...
public class FloydWarshall {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.FloydWarshall</tt> data type.
     */

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.ThreeSumFast.java
 *  Execution:    java edu.princeton.cs.algs4.ThreeSumFast input.txt
 *  Dependencies: edu.princeton.cs.algs4.StdOut.java edu.princeton.cs.algs4.In.java edu.princeton.cs.algs4.Stopwatch.java
 ...
 *
 *
 *  % java edu.princeton.cs.algs4.ThreeSumFast 1Kints.txt
 *  70
 *
 *  % java edu.princeton.cs.algs4.ThreeSumFast 2Kints.txt
 *  528
 *
 *  % java edu.princeton.cs.algs4.ThreeSumFast 4Kints.txt
 *  4039
 *
 *  % java edu.princeton.cs.algs4.ThreeSumFast 8Kints.txt
 *  32074
 *
 *  % java edu.princeton.cs.algs4.ThreeSumFast 16Kints.txt
 *  255181
 *
 *  % java edu.princeton.cs.algs4.ThreeSumFast 32Kints.txt
 *  2052358
 *
 *************************************************************************/
...
/**
 * The <tt>edu.princeton.cs.algs4.ThreeSumFast</tt> class provides static methods for counting

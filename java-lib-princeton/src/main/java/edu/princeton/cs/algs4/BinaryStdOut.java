 ...
 * <p/>
 * The client should not intermixing calls to <tt>edu.princeton.cs.algs4.BinaryStdOut</tt> with calls
 * to <tt>edu.princeton.cs.algs4.StdOut</tt> or <tt>System.out</tt>; otherwise unexpected behavior
 * will result.
 *

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Out.java
 *  Execution:    java edu.princeton.cs.algs4.Out
 *
...
public class Out {
    ...
    // assume language = English, country = US for consistency with edu.princeton.cs.algs4.In
    private static final Locale LOCALE = Locale.US;

    private PrintWriter out;

    /**
     * Create an edu.princeton.cs.algs4.Out object using an OutputStream.
     */
    ...
    /**
     * Create an edu.princeton.cs.algs4.Out object using standard output.
     */
    public Out() {
        this(System.out);
    }
    ...
    /**
     * Create an edu.princeton.cs.algs4.Out object using a Socket.
     */
    ...
    /**
     * Create an edu.princeton.cs.algs4.Out object using a file specified by the given name.
     */
    public Out(String s) {
        try {

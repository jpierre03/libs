 ...
 *  Compilation:  javac edu.princeton.cs.algs4.EdgeWeightedGraph.java
 *  Execution:    java edu.princeton.cs.algs4.EdgeWeightedGraph filename.txt
 *  Dependencies: edu.princeton.cs.algs4.Bag.java edu.princeton.cs.algs4.Edge.java edu.princeton.cs.algs4.In.java edu.princeton.cs.algs4.StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/43mst/tinyEWG.txt
 *
 *  An edge-weighted undirected graph, implemented using adjacency lists.
 *  Parallel edges and self-loops are permitted.
 *
 *  % java edu.princeton.cs.algs4.EdgeWeightedGraph tinyEWG.txt
 *  8 16
...
/**
 * The <tt>edu.princeton.cs.algs4.EdgeWeightedGraph</tt> class represents an edge-weighted
...
public class EdgeWeightedGraph {
     ...
     * <tt>for (edu.princeton.cs.algs4.Edge e : G.edges())</tt>.
     *
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.EdgeWeightedGraph</tt> data type.
     */

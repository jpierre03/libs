 ...
 *  Compilation:  javac edu.princeton.cs.algs4.ThreeSum.java
 *  Execution:    java edu.princeton.cs.algs4.ThreeSum input.txt
 *  Dependencies: edu.princeton.cs.algs4.In.java edu.princeton.cs.algs4.StdOut.java edu.princeton.cs.algs4.Stopwatch.java
...
/**
 * The <tt>edu.princeton.cs.algs4.ThreeSum</tt> class provides static methods for counting

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.GraphGenerator.java
 *  Execution:    java edu.princeton.cs.algs4.GraphGenerator V E
 *  Dependencies: edu.princeton.cs.algs4.Graph.java
 *
 *  A graph generator.
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.GraphGenerator</tt> class provides static methods for creating
...
public class GraphGenerator {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.GraphGenerator</tt> library.
     */

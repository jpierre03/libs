 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Draw.java
 *  Execution:    java edu.princeton.cs.algs4.Draw
 *
...
/**
 * <i>edu.princeton.cs.algs4.Draw</i>. This class provides a basic capability for
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    /**
     * edu.princeton.cs.algs4.Draw a line from (x0, y0) to (x1, y1).
     *
    ...
    /**
     * edu.princeton.cs.algs4.Draw one pixel at (x, y).
     *
    ...
    /**
     * edu.princeton.cs.algs4.Draw a point at (x, y).
     *
    ...
    /**
     * edu.princeton.cs.algs4.Draw a circle of radius r, centered on (x, y).
     *
    ...
    /**
     * edu.princeton.cs.algs4.Draw filled circle of radius r, centered on (x, y).
     *
     * @param x the x-coordinate of the center of the circle
     * @param y the y-coordinate of the center of the circle
     * @param r the radius of the circle
    ...
    /**
     * edu.princeton.cs.algs4.Draw an ellipse with given semimajor and semiminor axes, centered on (x, y).
     *
    ...
    /**
     * edu.princeton.cs.algs4.Draw an arc of radius r, centered on (x, y), from angle1 to angle2 (in degrees).
     *
     * @param x      the x-coordinate of the center of the circle
     * @param y      the y-coordinate of the center of the circle
     * @param r      the radius of the circle
    ...
    /**
     * edu.princeton.cs.algs4.Draw a square of side length 2r, centered on (x, y).
     *
    ...
    /**
     * edu.princeton.cs.algs4.Draw a filled square of side length 2r, centered on (x, y).
     *
     * @param x the x-coordinate of the center of the square
     * @param y the y-coordinate of the center of the square
     * @param r radius is half the length of any side of the square
    ...
    /**
     * edu.princeton.cs.algs4.Draw a rectangle of given half width and half height, centered on (x, y).
     *
    ...
    /**
     * edu.princeton.cs.algs4.Draw a filled rectangle of given half width and half height, centered on (x, y).
     *
     * @param x          the x-coordinate of the center of the rectangle
     * @param y          the y-coordinate of the center of the rectangle
     * @param halfWidth  is half the width of the rectangle
    ...
    /**
     * edu.princeton.cs.algs4.Draw a polygon with the given (x[i], y[i]) coordinates.
     *
    ...
    /**
     * edu.princeton.cs.algs4.Draw a filled polygon with the given (x[i], y[i]) coordinates.
     *
     * @param x an array of all the x-coordindates of the polygon
     * @param y an array of all the y-coordindates of the polygon
     */
    ...
    /**
     * edu.princeton.cs.algs4.Draw picture (gif, jpg, or png) centered on (x, y).
     *
    ...
    /**
     * edu.princeton.cs.algs4.Test client.
     */

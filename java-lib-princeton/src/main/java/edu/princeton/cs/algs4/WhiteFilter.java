...
/**
 * **********************************************************************
 * Compilation:  javac edu.princeton.cs.algs4.WhiteFilter.java
 * Execution:    java edu.princeton.cs.algs4.WhiteFilter whitelist.txt < input.txt
 * Dependencies: edu.princeton.cs.algs4.SET edu.princeton.cs.algs4.In.java edu.princeton.cs.algs4.StdIn.java edu.princeton.cs.algs4.StdOut.java

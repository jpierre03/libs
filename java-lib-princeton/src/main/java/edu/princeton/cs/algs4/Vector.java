 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Vector.java
 *  Execution:    java edu.princeton.cs.algs4.Vector
 *
 *  Implementation of a vector of real numbers.
 *
 *  This class is implemented to be immutable: once the client program
 *  initialize a edu.princeton.cs.algs4.Vector, it cannot change any of its fields
 *  (N or data[i]) either directly or indirectly. Immutability is a
 *  very desirable feature of a data type.
 *
 *  % java edu.princeton.cs.algs4.Vector
 *     x     = [ 1.0 2.0 3.0 4.0 ]
 *     y     = [ 5.0 2.0 4.0 1.0 ]
 *     z     = [ 6.0 4.0 7.0 5.0 ]
 ...
 *
 *
 *  Note that edu.princeton.cs.algs4.Vector is also the name of an unrelated Java library class.
 *
 *************************************************************************/

/**
 * The <tt>edu.princeton.cs.algs4.Vector</tt> class represents a <em>d</em>-dimensional mathematical vector.
...
public class Vector {
     ...
     * arugments such as edu.princeton.cs.algs4.Vector x = new edu.princeton.cs.algs4.Vector(1.0, 2.0, 3.0, 4.0).
     *

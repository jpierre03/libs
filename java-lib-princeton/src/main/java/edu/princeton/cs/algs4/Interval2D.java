 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Interval2D.java
 *  Execution:    java edu.princeton.cs.algs4.Interval2D
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.Interval2D</tt> class represents a closed two-dimensional interval,
 ...
 * The class <code>edu.princeton.cs.algs4.Interval2D</code> includes methods for checking whether
...
public class Interval2D {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.Interval2D</tt> data type.
     */

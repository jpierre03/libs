 ...
 *  Compilation:  javac edu.princeton.cs.algs4.BinaryOut.java
 *  Execution:    java edu.princeton.cs.algs4.BinaryOut
 *
 ...
 * <p/>
 * The client should not intermixing calls to <tt>edu.princeton.cs.algs4.BinaryOut</tt> with calls
 * to <tt>edu.princeton.cs.algs4.Out</tt>; otherwise unexpected behavior will result.
 *
...
public final class BinaryOut {
    ...
    /**
     * edu.princeton.cs.algs4.Test client. Read bits from standard input and write to the file

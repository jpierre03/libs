 ...
 *  Compilation:  javac edu.princeton.cs.algs4.QuickFindUF.java
 *  Execution:  java edu.princeton.cs.algs4.QuickFindUF < input.txt
 *  Dependencies: edu.princeton.cs.algs4.StdIn.java edu.princeton.cs.algs4.StdOut.java
 *
 *  edu.princeton.cs.algs4.Quick-find algorithm.
 *
 ****************************************************************************/

/**
 * The <tt>edu.princeton.cs.algs4.QuickFindUF</tt> class represents a union-find data structure.

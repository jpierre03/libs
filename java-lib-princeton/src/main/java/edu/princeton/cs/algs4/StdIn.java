...
/**
 * The <tt>edu.princeton.cs.algs4.StdIn</tt> class provides static methods for reading strings
 ...
 * mask. If the input begins with the optional byte-order mask, <tt>edu.princeton.cs.algs4.StdIn</tt>

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.UF.java
 *  Execution:    java edu.princeton.cs.algs4.UF < input.txt
 ...
 *
 *  % java edu.princeton.cs.algs4.UF < tinyUF.txt
 *  4 3
 *  3 8
 *  6 5
 *  9 4
...
/**
 * The <tt>edu.princeton.cs.algs4.UF</tt> class represents a <em>union-find data type</em>
 ...
 * <em>equivalence classes</em> (or <em>components</em>). edu.princeton.cs.algs4.In this case,

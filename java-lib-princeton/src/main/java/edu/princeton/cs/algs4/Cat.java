 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Cat.java
 *  Execution:    java edu.princeton.cs.algs4.Cat input0.txt input1.txt ... output.txt
 *  Dependencies: edu.princeton.cs.algs4.In.java edu.princeton.cs.algs4.Out.java
 *
 ...
 *  test.
 *
 *  % java edu.princeton.cs.algs4.Cat in1.txt in2.txt out.txt
 *
 *  % more out.txt
 *  This is
 *  a tiny
...
/**
 * The <tt>edu.princeton.cs.algs4.Cat</tt> class provides a client for concatenating the results

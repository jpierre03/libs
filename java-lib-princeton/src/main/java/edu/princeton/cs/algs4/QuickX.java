 ...
 *  Compilation:  javac edu.princeton.cs.algs4.QuickX.java
 *  Execution:    java edu.princeton.cs.algs4.QuickX N
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.QuickX</tt> class provides static methods for sorting an

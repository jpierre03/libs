...
/*************************************************************************
 *  Compilation:  javac edu.princeton.cs.algs4.StdStats.java
 *  Execution:    java edu.princeton.cs.algs4.StdStats < input.txt
 *
 ...
 *  3.0 1.0 2.0 5.0 4.0
 *
 *  % java edu.princeton.cs.algs4.StdStats < tiny.txt
 *         min   1.000
 *        mean   3.000
 *         max   5.000
 *     std dev   1.581
...
public final class StdStats {
    ...
    public static double max(double[] a) {
        ...
        for (double anA : a) {
            if (Double.isNaN(anA)) return Double.NaN;
            if (anA > max) max = anA;
        }
        return max;
    }

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Arbitrage.java
 *  Execution:    java edu.princeton.cs.algs4.Arbitrage < input.txt
 *  Dependencies: edu.princeton.cs.algs4.EdgeWeightedDigraph.java edu.princeton.cs.algs4.DirectedEdge.java
 *                edu.princeton.cs.algs4.BellmanFordSP.java
 *  Data file:    http://algs4.cs.princeton.edu/44sp/rates.txt
 *
 *  edu.princeton.cs.algs4.Arbitrage detection.
 *
 *  % more rates.txt
 *  5
 ...
 *
 *  % java edu.princeton.cs.algs4.Arbitrage < rates.txt
...
/**
 * The <tt>edu.princeton.cs.algs4.Arbitrage</tt> class provides a client that finds an arbitrage

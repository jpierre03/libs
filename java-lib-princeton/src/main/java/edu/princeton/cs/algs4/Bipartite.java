 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Bipartite.java
...
/**
 * The <tt>edu.princeton.cs.algs4.Bipartite</tt> class represents a data type for
...
public class Bipartite {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.Bipartite</tt> data type.
     */

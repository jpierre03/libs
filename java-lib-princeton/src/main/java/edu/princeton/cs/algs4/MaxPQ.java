 ...
 *  Compilation:  javac edu.princeton.cs.algs4.MaxPQ.java
 *  Execution:    java edu.princeton.cs.algs4.MaxPQ < input.txt
 *
 *  Generic max priority queue implementation with a binary heap.
 *  Can be used with a comparator instead of the natural order,
 *  but the generic Key type must still be Comparable.
 *
 *  % java edu.princeton.cs.algs4.MaxPQ < tinyPQ.txt
 *  Q X P (6 left on pq)
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.MaxPQ</tt> class represents a priority queue of generic keys.
...
public class MaxPQ<Key> implements Iterable<Key> {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.MaxPQ</tt> data type.
     */

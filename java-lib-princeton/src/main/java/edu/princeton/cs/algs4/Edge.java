 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Edge.java
 *  Execution:    java edu.princeton.cs.algs4.Edge
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.Edge</tt> class represents a weighted edge in an
...
public class Edge implements Comparable<Edge> {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.Edge</tt> data type.
     */

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.In.java
 *  Execution:    java edu.princeton.cs.algs4.In   (basic test --- see source for required files)
 *
...
public final class In {
    ...
    /**
     * begin: section (1 of 2) of code duplicated from edu.princeton.cs.algs4.In to edu.princeton.cs.algs4.StdIn
     */
    ...
    /*** end: section (1 of 2) of code duplicated from edu.princeton.cs.algs4.In to edu.princeton.cs.algs4.StdIn */
     ...
     *             <tt>new edu.princeton.cs.algs4.In(filename)</tt>.{@link #readAllInts()}
     */
    public static int[] readInts(String filename) {
        return new In(filename).readAllInts();
    }

    /*** begin: section (2 of 2) of code duplicated from edu.princeton.cs.algs4.In to edu.princeton.cs.algs4.StdIn,
     ...
     *
     * @deprecated Clearer to use
     *             <tt>new edu.princeton.cs.algs4.In(filename)</tt>.{@link #readAllDoubles()}
     */
     ...
     *
     * @deprecated Clearer to use
     *             <tt>new edu.princeton.cs.algs4.In(filename)</tt>.{@link #readAllStrings()}
     */
    ...
    /*** end: section (2 of 2) of code duplicated from edu.princeton.cs.algs4.In to edu.princeton.cs.algs4.StdIn */

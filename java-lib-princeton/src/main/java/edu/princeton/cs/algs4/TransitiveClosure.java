 ...
 *  Compilation:  javac edu.princeton.cs.algs4.TransitiveClosure.java
 *  Execution:    java edu.princeton.cs.algs4.TransitiveClosure filename.txt
 *  Dependencies: edu.princeton.cs.algs4.Digraph.java edu.princeton.cs.algs4.DepthFirstDirectedPaths.java edu.princeton.cs.algs4.In.java edu.princeton.cs.algs4.StdOut.java
 ...
 *  Space: O(V^2).
 *
 *  % java edu.princeton.cs.algs4.TransitiveClosure tinyDG.txt
...
/**
 * The <tt>edu.princeton.cs.algs4.TransitiveClosure</tt> class represents a data type for
...
public class TransitiveClosure {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.TransitiveClosure</tt> data type.
     */

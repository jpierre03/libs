 ...
 *  Compilation:  javac edu.princeton.cs.algs4.TarjanSCC.java
 *  Execution:    Java edu.princeton.cs.algs4.TarjanSCC V E
 *  Dependencies: edu.princeton.cs.algs4.Digraph.java edu.princeton.cs.algs4.Stack.java edu.princeton.cs.algs4.TransitiveClosure.java edu.princeton.cs.algs4.StdOut.java
 *
 ...
 *  Runs in O(E + V) time.
 *
 *  % java edu.princeton.cs.algs4.TarjanSCC tinyDG.txt
 *  5 components
 *  1
 *  0 2 3 4 5
 *  9 10 11 12
...
/**
 * The <tt>edu.princeton.cs.algs4.TarjanSCC</tt> class represents a data type for
...
public class TarjanSCC {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.TarjanSCC</tt> data type.
     */

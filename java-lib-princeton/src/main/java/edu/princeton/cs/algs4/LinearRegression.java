 ...
 *  Compilation:  javac edu.princeton.cs.algs4.LinearRegression.java
 *  Execution:    java  edu.princeton.cs.algs4.LinearRegression
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.LinearRegression</tt> class performs a simple linear regression

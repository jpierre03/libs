 ...
 *  Compilation:  javac edu.princeton.cs.algs4.KosarajuSharirSCC.java
 *  Execution:    java edu.princeton.cs.algs4.KosarajuSharirSCC filename.txt
 *  Dependencies: edu.princeton.cs.algs4.Digraph.java edu.princeton.cs.algs4.TransitiveClosure.java edu.princeton.cs.algs4.StdOut.java edu.princeton.cs.algs4.In.java
 ...
 *  7
 *
 *  % java edu.princeton.cs.algs4.KosarajuSharirSCC mediumDG.txt
 *  10 components
 *  21
 ...
 *  10
 *
 *  % java -Xss50m edu.princeton.cs.algs4.KosarajuSharirSCC mediumDG.txt
 *  25 components
...
/**
 * The <tt>edu.princeton.cs.algs4.KosarajuSharirSCC</tt> class represents a data type for
...
public class KosarajuSharirSCC {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.KosarajuSharirSCC</tt> data type.
     */

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.BoruvkaMST.java
 *  Execution:    java edu.princeton.cs.algs4.BoruvkaMST filename.txt
 *  Dependencies: edu.princeton.cs.algs4.EdgeWeightedGraph.java edu.princeton.cs.algs4.Edge.java edu.princeton.cs.algs4.Bag.java
 ...
 *
 *  % java edu.princeton.cs.algs4.BoruvkaMST tinyEWG.txt
 *  0-2 0.26000
 *  6-2 0.40000
 *  5-7 0.28000
 *  4-5 0.35000
...
/**
 * The <tt>edu.princeton.cs.algs4.BoruvkaMST</tt> class represents a data type for computing a
...
public class BoruvkaMST {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.BoruvkaMST</tt> data type.
     */

 ...
 *  Compilation:  javac edu.princeton.cs.algs4.BinaryIn.java
 *  Execution:    java edu.princeton.cs.algs4.BinaryIn input output
 *
 *  This library is for reading binary data from an input stream.
 *
 *  % java edu.princeton.cs.algs4.BinaryIn http://introcs.cs.princeton.edu/cover.jpg output.jpg
 *
 *************************************************************************/
 ...
 * byte first) order.
 * <p/>
 * The client should not intermix calls to <tt>edu.princeton.cs.algs4.BinaryIn</tt> with calls
 * to <tt>edu.princeton.cs.algs4.In</tt>; otherwise unexpected behavior will result.
 *
...
public final class BinaryIn {
    ...
    /**
     * edu.princeton.cs.algs4.Test client. Reads in the name of a file or url (first command-line

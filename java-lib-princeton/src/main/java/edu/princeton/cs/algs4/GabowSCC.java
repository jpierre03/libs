 ...
 *  Compilation:  javac edu.princeton.cs.algs4.GabowSCC.java
 *  Execution:    java edu.princeton.cs.algs4.GabowSCC V E
 ...
 *  Runs in O(E + V) time.
 *
 *  % java edu.princeton.cs.algs4.GabowSCC tinyDG.txt
 *  5 components
 *  1
 *  0 2 3 4 5
 *  9 10 11 12
...
/**
 * The <tt>edu.princeton.cs.algs4.GabowSCC</tt> class represents a data type for
...
public class GabowSCC {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.GabowSCC</tt> data type.
     */

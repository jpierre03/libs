 ...
 *  Compilation:  javac edu.princeton.cs.algs4.Interval1D.java
 *  Execution:    java edu.princeton.cs.algs4.Interval1D
 *
...
/**
 * The <tt>edu.princeton.cs.algs4.Interval1D</tt> class represents a one-dimensional closed interval.
 * Intervals are immutable: their values cannot be changed after they are created.
 * The class <code>edu.princeton.cs.algs4.Interval1D</code> includes methods for checking whether
...
public class Interval1D {
    ...
    /**
     * Unit tests the <tt>edu.princeton.cs.algs4.Interval1D</tt> data type.
     */

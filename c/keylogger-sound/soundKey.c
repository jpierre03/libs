 ...
 *
 * Compile:
 *  g++ -ansi -Wall -pedantic -O3 -o soundKey soundKey.C -L/usr/X11R6/lib -lX11 && ./soundKey :0
 *    or
 *  icc -ansi -Wall -w1 -O3 -o soundkey soundkey.C -L/usr/X11R6/lib -lX11
 *
 *  strip -s -R .comment -R .note -R .note.ABI-tag soundkey
 */
...
//jpierre03
              if(key == "Return"){
                  system("paplay /usr/share/focuswriter/sounds/keyenter.wav &");
              }
              if(key != "Return"){
                  system("paplay /usr/share/focuswriter/sounds/keyany.wav &");
              }
//jpierre03 - end
